...
self.ClusterFuncMenu = ...
	uicontrol(panel0, 'Style', 'CheckBox', ...
	'Units', 'Normalized','Position', [0.3 0 0.4 1], ...
	'Style', 'popupmenu', ...
...
uicontrol('Parent', panel0, ...
	'Units', 'Normalized', 'Position', [0.7 0 0.1 1], ...
	'Style', 'popupmenu', ...
...
uicontrol('Parent', panel0, ...
	'Units', 'Normalized', 'Position', [0.8 0 0.1 1], ...
	'Style', 'popupmenu', ...
...
uicontrol('Parent', panel0, ...
	...
	'String', '', ...
	'Tag', 'MarkerSizeSelf', ...
	'Callback', @(src,event)ChangeScore(self), ...
	'TooltipString', 'Change cluster score');
end